...
import TouchKeyboard from './common/NeumorphicKeyboard'
import { usePosStore } from '../../../store/posStore'
import { posNotifySuccess } from '../../../lib/posNotify'

export default function LiteCommentsModal({ onClose, onSave }) {
  ...
  const handleDone = () => {
    ...
    posNotifySuccess('Comment saved', { title: 'Comments', duration: 1200 })
    onClose()
  }
